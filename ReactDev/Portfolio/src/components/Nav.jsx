...
const Nav = ({handleAboutClick,handleHomeClick,handleContactClick,handleEduClick,handleProjectClick,contactRef,projectRef,eduRef,aboutRef,homeRef}) => {
  ...
  return (
    <header className="w-full bg-black/60 flex px-5 fixed h-20 items-center z-50 justify-end backdrop-blur-md">
       <h1 className="cursor-pointer flex flex-grow items-center text-yellow-500 text-4xl px-10" onClick={handleHomeClick}>
        Shubh's Portfolio
      </h1>
      <div
